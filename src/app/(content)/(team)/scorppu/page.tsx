...
import ProfileGitHubActivity from "@/components/team/profile/ProfileGithubActivity";
...
export default function Scorppu() {
  ...
  return (
    <div className="pt-10 pb-10">
      ...
      <ProfileDivider/><ProfileGitHubActivity username="scorppu"></ProfileGitHubActivity>
